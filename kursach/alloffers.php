    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            ...
            if (isset($_SESSION["role"]) && $_SESSION["role"] === "admin") {
                ...
                echo '<a class="nav-link text-white" href="#" style="font-size: 20px; ">Предложенные парковки</a>';
                echo '</li>';
            }
            ?>
            </ul>
...
$sql = "SELECT id, MetroStation, MetroLine, Schedule, Price FROM offer_parks";
...
<div class="px-5">
    <h3 class="text-center mb-1 mt-4">Список предложенных парковок</h3>
    <?php
    if (!empty($parkData)){
    ...
    <table class="table" style="">
        <thead>
            <tr>
                <th scope="col" class="text-center">Номер заявки</th>
        ...
        <?php else: ?>
        <tr>
            <td colspan="5" class="text-center">На данный момент нет актуальных заявок</td>
        </tr>
        <?php endif; ?>    
        </tbody>
    </table>
...
<script>
    ...
    function redirectToParking(parkingId) {
        ...
        window.location.href = 'offer_park.php?id=' + parkingId;
